...
`titre` varchar(80) NOT NULL, `prix` decimal(5,2) NOT NULL,
...
'Douglas', 'Adams'), ('2', 'Dune', '18.00', 'Frank Herbert', 'Hachette', 'Science fiction', '1995-03-09', 'américan', 'français', 'Frank', 'Herbert'), ('3', 'La nausée', '12.50', 'J.P. Sartre', 'PUF', 'Essai', '1988-12-11', 'français', 'français', 'J.P.', 'Sartre'), ('4', 'Désir et servitude', '9.00', 'F. Lordon', 'PUF', 'Essai', '2002-06-26', 'français',
...
raison pure', '12.00', 'Emmanuel Kant', 'PUF', 'Philosophie', '2000-09-04', 'français', 'français', 'Emmanuel', 'Kant'), ('7', 'Propos sur le bonheur', '9.00', ' Alain', 'PUF', 'Philosophie', '1989-11-09', 'français', 'français', null, 'Alain'), ('8', 'Fondation', '14.00', 'Isaac Asimov', 'Robert Laffont', 'Science fiction', '1990-07-26', 'américain',
...
'Highsmith'), ('21', 'Ripley et les ombres', '22.00', 'Patricia Highsmith', 'Hachette', 'Roman policier', '2007-07-26', 'américain', 'français', 'Patricia', 'Highsmith'), ('26', 'D\'un retournement l\'autre', '9.00', 'F. Lordon', 'La Fabrique', 'Théâtre', '2006-08-24', 'français', 'français', 'F.', 'Lordon'), ('27', 'Imperium', '15.00', 'F. Lordon', 'La
